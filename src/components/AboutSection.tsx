...
import { User, Tag, ShieldCheck, BarChart3, Heart, Award, Sparkles, CheckCircle2, MessageCircle } from 'lucide-react';
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="space-y-4 pt-1">
              ...
              <p className="text-slate-200 text-sm sm:text-base lg:text-[17px] leading-relaxed lg:leading-relaxed font-normal">
                {creator.bioParagraph1 || "Sou Leonardo Mey, formado em Processos Gerenciais, copywriter e especialista em marketing, vendas e mercado digital há mais de 10 anos."}
              </p>

              <p className="text-slate-200 text-sm sm:text-base lg:text-[17px] leading-relaxed lg:leading-relaxed font-normal">
                {creator.bioParagraph2 || "Sou cristão, marido da Janaína e pai da Alice e do Joaquim. Meu compromisso é com Deus, com a minha família e com cada pessoa que acompanha o meu trabalho."}
              </p>

              {(creator.bioParagraph3 || creator.bioParagraph3 === undefined) && (
                <div className="relative border-l-4 border-amber-400 bg-gradient-to-r from-amber-500/15 via-slate-900/80 to-slate-950/60 p-4 rounded-r-2xl border-y border-r border-amber-500/20 shadow-md my-2">
                  <p className="text-amber-300 text-sm sm:text-base lg:text-[16px] leading-relaxed font-semibold italic">
                    "{creator.bioParagraph3 || "Por isso, levo minhas análises e recomendações com seriedade, responsabilidade e transparência, sempre respeitando quem confia em mim."}"
                  </p>
                </div>
              )}
            </div>
