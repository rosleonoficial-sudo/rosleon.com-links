...
export const PartnershipsCard: React.FC<PartnershipsCardProps> = ({ creator, stats, instagramStats }) => {
  ...
  const totalViewsCompact = `+${(totalViewsRaw / 1_000_000).toFixed(1).replace('.', ',')} MILHÕES`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-bold text-slate-200 mt-0.5 flex items-center gap-1">
                      ...
                      <span className="text-amber-400 font-extrabold">✓ Oficial</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="md:col-span-4 flex justify-center py-2">
            <div className="relative group">
              ...
              {/* Verified Badge */}
              <div className="absolute bottom-1 right-1 bg-amber-400 text-slate-950 p-1.5 rounded-full shadow-lg border-2 border-slate-900" title="Criador Verificado">
          ...
          <div className="md:col-span-4 space-y-4 text-left">
            ...
            <div className="p-3 rounded-2xl bg-slate-950/80 border border-slate-800/80 shadow-sm space-y-2">
              <div className="flex items-center justify-between text-amber-400 text-[10px] font-extrabold uppercase tracking-wider">
                ...
                <span className="text-[9px] text-slate-400 font-semibold">(VÍDEOS & REELS)</span>
              </div>
            ...
            {/* 3. Botão de Contato Comercial com Animação Leve e Elegante */}
            <div className="pt-2 relative group">
              {/* Soft amber backlight glow - subtle and smooth */}
              ...
              {/* Botão com Pulso Leve e Brilho Deslizante Suave */}
              <a
